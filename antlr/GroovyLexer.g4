...
@members {
    ...
    private void ignoreMultiLineCommentConditionally() {
        if (!this.isInsideParens() && SemanticPredicates.isFollowedByWhiteSpaces(_input)) {
            return;
        }
...
StringLiteral
    ...
    |   Slash { this.isRegexAllowed() && this._input.LA(1) !== '*'.charCodeAt(0) }?  SlashyStringCharacter+  Slash
...
TdqGStringBegin
    ...
    ;
SlashyGStringBegin
    :   Slash { this.isRegexAllowed() && this._input.LA(1) !== '*'.charCodeAt(0) }? SlashyStringCharacter* Dollar { SemanticPredicates.isFollowedByJavaLetterInGString(this._input) }? -> type(GStringBegin), pushMode(SLASHY_GSTRING_MODE), pushMode(GSTRING_TYPE_SELECTOR_MODE)
    ;
...
fragment TdqStringCharacter
    :   ~["\\$]
    |   GStringQuotationMark { this._input.LA(1) !== QUOTE_CHAR || this._input.LA(2) !== QUOTE_CHAR || this._input.LA(3) === QUOTE_CHAR && (this._input.LA(4) !== QUOTE_CHAR || this._input.LA(5) !== QUOTE_CHAR) }?
    |   EscapeSequence
    ;
...
fragment TsqStringCharacter
    :   ~['\\]
    |   SqStringQuotationMark { this._input.LA(1) !== SINGLE_QUOTE_CHAR || this._input.LA(2) !== SINGLE_QUOTE_CHAR || this._input.LA(3) === SINGLE_QUOTE_CHAR && (this._input.LA(4) !== SINGLE_QUOTE_CHAR || this._input.LA(5) !== SINGLE_QUOTE_CHAR) }?
    |   EscapeSequence
    ;
...
fragment DollarSlashyStringCharacter
    ...
    |   Slash { this._input.LA(1) !== '$'.charCodeAt(0) }?
    |   Dollar { !SemanticPredicates.isFollowedByJavaLetterInGString(this._input) }?
    |   ~[/$\u0000]
    ;
...
IntegerLiteral
    :   (   DecimalIntegerLiteral
        ...
        ) (Underscore { throw new Error("Number ending with underscores is invalid"); })?

    // !!! Error Alternative !!!
    |   Zero ([0-9] { this.invalidDigitCount++; })+ { throw new Error("Invalid octal number"); } IntegerTypeSuffix?
    ;
...
CapitalizedIdentifier
    :   JavaLetter {GroovyCharacter.isUppercase(this._input.LA(-1))}? JavaLetterOrDigit*
    ;
...
JavaLetter
    ...
    |   // covers all characters above 0x7F which are not a surrogate
        ~[\u0000-\u007F\uD800-\uDBFF]
        { GroovyCharacter.isJavaIdentifierStartAndNotIdentifierIgnorable(this._input.LA(-1)) }?
    |   // covers UTF-16 surrogate pairs encodings for U+10000 to U+10FFFF
        [\uD800-\uDBFF] [\uDC00-\uDFFF]
        { GroovyCharacter.isJavaIdentifierStart( [this._input.LA(-2), this._input.LA(-1)] ) }?
    ;

fragment
JavaLetterInGString
    :   JavaLetter { this._input.LA(-1) !== '$'.charCodeAt(0) }?
    ;
...
JavaLetterOrDigit
    ...
    |   // covers all characters above 0x7F which are not a surrogate
        ~[\u0000-\u007F\uD800-\uDBFF]
        { GroovyCharacter.isJavaIdentifierPartAndNotIdentifierIgnorable(this._input.LA(-1)) }?
    |   // covers UTF-16 surrogate pairs encodings for U+10000 to U+10FFFF
        [\uD800-\uDBFF] [\uDC00-\uDFFF]
        { GroovyCharacter.isJavaIdentifierPart( this._input.LA(-2), this._input.LA(-1) ) }?
    ;

fragment
JavaLetterOrDigitInGString
    :   JavaLetterOrDigit  { this._input.LA(-1) !== '$'.charCodeAt(0) }?
    ;
...
SH_COMMENT
    :   '#!' { 
        ...
        } ShCommand (LineTerminator '#!' ShCommand)* -> skip
    ;
